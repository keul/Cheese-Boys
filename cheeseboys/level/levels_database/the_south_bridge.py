...
def load(name, hero):
    ...
    exit1 = LevelExit(
        (18, 208),
        (36, 170),
        "Western Cavallotti Riverside 1",
        (1500, 310),
        (1200, 290),
        (1500, 310),
        exits,
    ...
    level.addAnimation(
        (535, 1475), CodigoroSign((535, 1475), (80, 53), animations, physical)
    )
