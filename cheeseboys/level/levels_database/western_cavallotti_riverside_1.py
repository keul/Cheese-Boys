...
def load(name, hero):
    ...
    boss = character.Character(
        "The Boss",
        ("enemy2_sword.png", "enemy2.png"),
        (all, charas, enemies, physical),
        realSize=(18, 25),
        speed=140.0,
        weaponInAndOut=True,
    )
    ...
    boss.rest_time_needed = 0.25

    enemy1 = character.Character(
        "Phil",
        ("enemy1_sword.png", "enemy1.png"),
        (all, charas, enemies, physical),
        realSize=(18, 25),
        speed=130.0,
        weaponInAndOut=True,
    ...
    triggerPresentation.setOptions(
        "boss-animation",
        presentation_dir="data/presentations/western-cavallotti-riverside",
    )
    level.addSprite(triggerPresentation)

    endPresentation = PresentationTrigger((15, 200), (30, 162), (hero,), triggers)
    endPresentation.setOptions(
        "demo-end", presentation_dir="data/presentations/western-cavallotti-riverside"
    )
