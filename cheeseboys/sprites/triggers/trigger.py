...
class Trigger(GameSprite):
    ...
    def fireTrigger(self, sprite):
        ...
        event = pygame.event.Event(
            cblocals.TRIGGER_FIRED_EVENT, {"trigger": self, "sprite": sprite}
        )
    ...
    def setOptions(self, **kwargs):
        ...
        raise NotImplementedError(
            "The setOptions method is not implemented in the Trigger class"
        )
    ...
    def getResult(self):
        ...
        """
        raise NotImplementedError(
            "The getResult method is not implemented in the Trigger class"
        )
