# This is the Will McGugan's gameobjects library (ver 0.0.3).
# I really don't like to use this class inside my project in this way...
# I find better that every gamer download and install the library as McGugan distribute it.
#
# Unluckily sometimes pygame users are a little dumb ;-)
# Some people simply don't install anything that need external dependencies.
...
class Vector2(object):
    ...
    def angle_between(self, v2):
        ...
        try:
            ...
            raise ValueError(
                "%s - Vectors must be normalized: gets %s and %s"
                % (str(inst), self, v2)
            )
