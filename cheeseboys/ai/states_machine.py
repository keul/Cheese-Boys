...
class State(object):
    ...
    def _chooseRandomDestination(self, maxdistance=200):
        ...
        randomdest = self.character.currentLevel.generateRandomPoint(
            fromPoint=self.character.position, maxdistance=maxdistance
        )
        self.character.navPoint.set(randomdest)
