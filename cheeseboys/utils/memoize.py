...
class memoize_charasimage(object):
    ...
    def __call__(self, character):
        ...
        if character in self.mem:
            ...
            if (
                character._attackDirection == _attackDirection
                and character._isMoving == _isMoving
                and character._mustChangeImage == _mustChangeImage
                and character._lastUsedDirection == _lastUsedDirection
            ):
                # print "cache hit"
                return image
        ...
        self.mem[character] = (
            image,
            character._attackDirection,
            character._isMoving,
            character._mustChangeImage,
            character._lastUsedDirection,
        )
        # print "cache miss"
        return image
...
class memoize_observer(object):
    """An object attributes memoization decorator; the method result is memoized as far as given property doesn't change"""
